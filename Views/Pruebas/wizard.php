...
<!--        <link href="<?= DIR_MEDIA ?>css/bootstrap-4-6-0.min.css" rel="stylesheet" />-->
        <link href="<?= DIR_MEDIA ?>tienda/vendor/bootstrap/css/bootstrap.min.css" rel="preload stylesheet" as="style" type="text/css"/>
        <link href="<?= DIR_MEDIA ?>css/wizardBootstrap.css" rel="stylesheet" />
    </head>
    <body>
    ...
    <script src="<?= DIR_MEDIA ?>js/jquery-3.6.0.min.js" type="text/javascript"></script>
    <script src="<?= DIR_MEDIA ?>tienda/vendor/bootstrap/js/bootstrap.js" type="text/javascript"></script>
    <script src="<?= DIR_MEDIA ?>js/wizardBootstrap.js" type="text/javascript"></script>
