...
function obtenerPaginasVisitadasEnFecha($fecha)
{
    ...
    from visitas where datecreated = ?
    group by url, pagina
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT COUNT(DISTINCT ip) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ? AND url = ?");
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT COUNT(*) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ? AND url = ?");
    $sentencia->execute([$fechaInicio, $fechaFin, $url]);
    return $sentencia->fetchObject()->conteo;
}
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT datecreated, COUNT(DISTINCT ip) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ? AND url = ? GROUP BY datecreated");
    $sentencia->execute([$fechaInicio, $fechaFin, $url]);
    return $sentencia->fetchAll();
}
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT datecreated, COUNT(*) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ? AND url = ? GROUP BY datecreated");
    $sentencia->execute([$fechaInicio, $fechaFin, $url]);
    return $sentencia->fetchAll();
}
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT COUNT(DISTINCT ip) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ?");
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT COUNT(*) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ?");
    $sentencia->execute([$fechaInicio, $fechaFin]);
    return $sentencia->fetchObject()->conteo;
}
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT datecreated, COUNT(DISTINCT ip) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ? GROUP BY datecreated");
    $sentencia->execute([$fechaInicio, $fechaFin]);
    return $sentencia->fetchAll();
}
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("SELECT datecreated, COUNT(*) AS conteo FROM visitas WHERE datecreated >= ? AND datecreated <= ? GROUP BY datecreated");
    $sentencia->execute([$fechaInicio, $fechaFin]);
    return $sentencia->fetchAll();
}
function registrarVisita($pagina, $url)
{
    ...
    $bd = obtenerConexion();
    $sentencia = $bd->prepare("INSERT INTO visitas(datecreated, ip, pagina, url) VALUES(?, ?, ?, ?)");
