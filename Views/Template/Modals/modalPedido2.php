<!-- Scrollable modal 
<div class="modal fade-in" id="modalFormCliente"  tabindex="-1" role="dialog"  aria-hidden="true" aria-labelledby="Formulario de nuevo Rol">-->
<div  class="modal     " id="modalpedido" aria-hidden='true'>
  <div class="modal-dialog modal-dialog-scrollable modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body" id="imprimeModalBody">
          ...
          <div class="tile">
            <section class="invoice">
              ...
              <div class="row d-print-none mt-2">
                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print('#modalpedido');" "><i class="fa fa-print"></i> Print</a></div>
              </div>
            </section>
          </div>
        </div>
