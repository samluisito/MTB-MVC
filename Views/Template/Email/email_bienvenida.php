...
<html lang="es">
    <head>
        ...
        <title>Bienvenido <?= $data['nombreUsuario']; ?></title>
        <style type="text/css">
            p{
                font-family: arial;
                letter-spacing: 1px;
                ...
                <tr>
                    <td>
                        <div class="x_sgwrap x_title_blue">
                            <h1><?= $data['empresa']['nombre_comercial']; ?></h1>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <a href="<?= base_url(); ?>" target="_blank" class="x_button_link x_link_blue">Visitar <?= $data['empresa']['nombre_comercial']; ?> </a>
                        <p class="x_title_gray"><a href="<?= 'https://' . $_SERVER['HTTP_HOST']; ?>" target="_blanck"><?= 'www' . $_SERVER['HTTP_HOST']; ?></a></p>
                    </td>
                </tr>
            </tbody>
        </table>
