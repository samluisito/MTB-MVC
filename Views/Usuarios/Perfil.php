          ...
          <div class="card">
            <div class="card-body p-0">
              <div class="user-profile-img">
                <img src="<?= DIR_MEDIA ?>vadmin/images/pattern-bg.webp" class="profile-img profile-foreground-img rounded-top" style="height: 120px;" alt="">
              ...
              <div class="mt-n5 position-relative">
                <div class="text-center">
                  <img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-3.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">

                  <div class="mt-3">
                    <h5 class="mb-1"><?= $usuario['nombres'] ?></h5>
                    <div>
              ...
              <div class=" mb-2 mt-3">
                <div class="d-flex align-items-center border-bottom py-3">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle">
                  </div>
                  <div class="flex-grow-1">
                    <div>
                ...
                <div class="d-flex align-items-center border-bottom py-3">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-3.jpg" alt="" class="img-fluid rounded-circle">
                  </div>
                  <div class="flex-grow-1">
                    <div>
                ...
                <div class="d-flex align-items-center pt-3">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle">
                  </div>
                  <div class="flex-grow-1">
                    <div>
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item py-3 px-0">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0 me-3">
                        <div>
                          <img src="<?= DIR_MEDIA ?>vadmin/images/small/img-4.jpg" alt="blog img" class="avatar-lg h-auto rounded">
                        </div>
                      </div>
                  ...
                  <li class="list-group-item py-3 px-0">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0 me-3">
                        <div>
                          <img src="<?= DIR_MEDIA ?>vadmin/images/small/img-3.jpg" alt="blog img" class="avatar-lg h-auto rounded">
                        </div>
                      </div>
                      <div class="flex-grow-1 overflow-hidden">
                  ...
                  <li class="list-group-item py-3 px-0">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0 me-3">
                        <div>
                          <img src="<?= DIR_MEDIA ?>vadmin/images/small/img-2.jpg" alt="blog img" class="avatar-lg h-auto rounded">
                        </div>
                      </div>
                      <div class="flex-grow-1 overflow-hidden">
                  ...
                  <li class="list-group-item py-3 px-0">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0 me-3">
                        <div>
                          <img src="<?= DIR_MEDIA ?>vadmin/images/small/img-9.jpg" alt="blog img" class="avatar-lg h-auto rounded">
                        </div>
                      </div>
                      <div class="flex-grow-1 overflow-hidden">
            ...
            <div class="card-body pt-1">
              <div class="table-responsive">
                <table class="table align-middle table-nowrap mb-0">
                  <tbody>
                    <tr>
                      <td style="width: 50px;"><img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-2.jpg" class="rounded-circle avatar-sm" alt=""></td>
                    ...
                    <tr>
                      <td><img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-1.jpg" class="rounded-circle avatar-sm" alt=""></td>
                    ...
                    <tr>
                      <td><img src="<?= DIR_MEDIA ?>vadmin/images/users/avatar-4.jpg" class="rounded-circle avatar-sm" alt=""></td>
