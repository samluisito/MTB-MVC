...
<!-- Modal Edit Perfil-->
<div class="wrap-modal1 js-modal1 p-t-60 p-b-20 show-modal"  bis_skin_checked="1"> 
  <div class="overlay-modal1 js-hide-modal1" bis_skin_checked="1"></div>
  <div class="container" bis_skin_checked="1">
    <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent" bis_skin_checked="1">
      ...
      <div class=" container" modal-body>
        ...
        <!--Formulario -->
        <form class="form" id="formPerfil" name="formPerfil">
