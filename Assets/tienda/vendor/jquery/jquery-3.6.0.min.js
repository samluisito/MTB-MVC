...
{global:{},add:function(a,b,c,e,f){var g,h,k,l;var m=t.get(a);if(ha(a)){if(c.handler){var n=c;c=n.handler;f=n.selector}f&&d.find.matchesSelector(ia,f);c.guid||(c.guid=d.guid++);(h=m.events)||(h=m.events=Object.create(null));(g=m.handle)||(g=m.handle=function(b){return"undefined"!==typeof d&&d.event.triggered!==b.type?d.event.dispatch.apply(a,arguments):void 0});b=(b||"").match(R)||[""];for(m=b.length;m--;){var p=Hb.exec(b[m])||[];var r=k=p[1];var u=(p[2]||"").split(".").sort();r&&(p=d.event.special[r]||
{},r=(f?p.delegateType:p.bindType)||r,p=d.event.special[r]||{},k=d.extend({type:r,origType:k,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:u.join(".")},n),(l=h[r])||(l=h[r]=[],l.delegateCount=0,p.setup&&!1!==p.setup.call(a,e,u,g)||a.addEventListener&&a.addEventListener(r,g,{passive:!0})),p.add&&(p.add.call(a,k),k.handler.guid||(k.handler.guid=c.guid)),f?l.splice(l.delegateCount++,0,k):l.push(k),d.event.global[r]=!0)}}},remove:function(a,b,c,e,
f){var g,h,k,l,m,n=t.hasData(a)&&t.get(a);if(n&&(k=n.events)){b=(b||"").match(R)||[""];for(l=b.length;l--;){var p=Hb.exec(b[l])||[];var r=m=p[1];var u=(p[2]||"").split(".").sort();if(r){var q=d.event.special[r]||{};r=(e?q.delegateType:q.bindType)||r;var v=k[r]||[];p=p[2]&&new RegExp("(^|\\.)"+u.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=v.length;g--;){var x=v[g];!f&&m!==x.origType||c&&c.guid!==x.guid||p&&!p.test(x.namespace)||e&&e!==x.selector&&("**"!==e||!x.selector)||(v.splice(g,1),x.selector&&v.delegateCount--,
q.remove&&q.remove.call(a,x))}h&&!v.length&&(q.teardown&&!1!==q.teardown.call(a,u,n.handle)||d.removeEvent(a,r,n.handle),delete k[r])}else for(r in k)d.event.remove(a,r+b[l],c,e,!0)}d.isEmptyObject(k)&&t.remove(a,"handle events")}},dispatch:function(a){var b,c,e,f=Array(arguments.length),g=d.event.fix(a);var h=(t.get(this,"events")||Object.create(null))[g.type]||[];var k=d.event.special[g.type]||{};f[0]=g;for(b=1;b<arguments.length;b++)f[b]=arguments[b];g.delegateTarget=this;if(!k.preDispatch||!1!==
k.preDispatch.call(this,g)){var l=d.event.handlers.call(this,g,h);for(b=0;(e=l[b++])&&!g.isPropagationStopped();)for(g.currentTarget=e.elem,h=0;(c=e.handlers[h++])&&!g.isImmediatePropagationStopped();)if(!g.rnamespace||!1===c.namespace||g.rnamespace.test(c.namespace))g.handleObj=c,g.data=c.data,c=((d.event.special[c.origType]||{}).handle||c.handler).apply(e.elem,f),void 0!==c&&!1===(g.result=c)&&(g.preventDefault(),g.stopPropagation());k.postDispatch&&k.postDispatch.call(this,g);return g.result}},
...
return this}if("object"===typeof a){for(e in a)this.off(e,b,a[e]);return this}if(!1===b||"function"===typeof b)c=b,b=void 0;!1===c&&(c=na);return this.each(function(){d.event.remove(this,a,c,b)})}});var rc=/<script|<style|<link/i,cc=/checked\s*(?:[^=]|=\s*.checked.)/i,dc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;d.extend({htmlPrefilter:function(a){return a},clone:function(a,b,c){var e,f=a.cloneNode(!0),g=ba(a);if(!(x.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){var h=F(f);var k=
F(a);var l=0;for(e=k.length;l<e;l++){var m=k[l],n=h[l],p=n.nodeName.toLowerCase();if("input"===p&&ta.test(m.type))n.checked=m.checked;else if("input"===p||"textarea"===p)n.defaultValue=m.defaultValue}}if(b)if(c)for(k=k||F(a),h=h||F(f),l=0,e=k.length;l<e;l++)ob(k[l],h[l]);else ob(a,f);h=F(f,"script");0<h.length&&Pa(h,!g&&F(a,"script"));return f},cleanData:function(a){for(var b,c,e,f=d.event.special,g=0;void 0!==(c=a[g]);g++)if(ha(c)){if(b=c[t.expando]){if(b.events)for(e in b.events)f[e]?d.event.remove(c,
e):d.removeEvent(c,e,b.handle);c[t.expando]=void 0}c[B.expando]&&(c[B.expando]=void 0)}}});d.fn.extend({detach:function(a){return qb(this,a,!0)},remove:function(a){return qb(this,a)},text:function(a){return O(this,function(a){return void 0===a?d.text(this):this.empty().each(function(){if(1===this.nodeType||11===this.nodeType||9===this.nodeType)this.textContent=a})},null,a,arguments.length)},append:function(){return oa(this,arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||
nb(this,a).appendChild(a)})},prepend:function(){return oa(this,arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=nb(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return oa(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return oa(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},empty:function(){for(var a,b=0;null!=(a=this[b]);b++)1===a.nodeType&&
...
null,a,arguments.length)},replaceWith:function(){var a=[];return oa(this,arguments,function(b){var c=this.parentNode;0>d.inArray(this,a)&&(d.cleanData(F(this)),c&&c.replaceChild(b,this))},a)}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var c=[],f=d(a),g=f.length-1,h=0;h<=g;h++)a=h===g?this:this.clone(!0),d(f[h])[b](a),Za.apply(c,a.get());return this.pushStack(c)}});var Ra=new RegExp("^("+
Gb+")(?!px)[a-z%]+$","i"),Ja=function(a){var b=a.ownerDocument.defaultView;b&&b.opener||(b=u);return b.getComputedStyle(a)},Ib=function(a,b,c){var d,f={};for(d in b)f[d]=a.style[d],a.style[d]=b[d];c=c.call(a);for(d in b)a.style[d]=f[d];return c},ec=new RegExp(T.join("|"),"i");(function(){function a(){if(l){k.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0";l.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%";
ia.appendChild(k).appendChild(l);var a=u.getComputedStyle(l);b="1%"!==a.top;h=12===Math.round(parseFloat(a.marginLeft));l.style.right="60%";f=36===Math.round(parseFloat(a.right));c=36===Math.round(parseFloat(a.width));l.style.position="absolute";e=12===Math.round(parseFloat(l.offsetWidth/3));ia.removeChild(k);l=null}}var b,c,e,f,g,h,k=v.createElement("div"),l=v.createElement("div");l.style&&(l.style.backgroundClip="content-box",l.cloneNode(!0).style.backgroundClip="",x.clearCloneStyle="content-box"===
l.style.backgroundClip,d.extend(x,{boxSizingReliable:function(){a();return c},pixelBoxStyles:function(){a();return f},pixelPosition:function(){a();return b},reliableMarginLeft:function(){a();return h},scrollboxSize:function(){a();return e},reliableTrDimensions:function(){if(null==g){var a=v.createElement("table");var b=v.createElement("tr");var c=v.createElement("div");a.style.cssText="position:absolute;left:-11111px;border-collapse:separate";b.style.cssText="border:1px solid";b.style.height="1px";
c.style.height="9px";c.style.display="block";ia.appendChild(a).appendChild(b).appendChild(c);c=u.getComputedStyle(b);g=parseInt(c.height,10)+parseInt(c.borderTopWidth,10)+parseInt(c.borderBottomWidth,10)===b.offsetHeight;ia.removeChild(a)}return g}}))})();var ub=["Webkit","Moz","ms"],tb=v.createElement("div").style,sb={},sc=/^(none|table(?!-c[ea]).+)/,Jb=/^--/,tc={position:"absolute",visibility:"hidden",display:"block"},Kb={letterSpacing:"0",fontWeight:"400"};d.extend({cssHooks:{opacity:{get:function(a,
b){if(b)return a=za(a,"opacity"),""===a?"1":a}}},cssNumber:{animationIterationCount:!0,columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,gridArea:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnStart:!0,gridRow:!0,gridRowEnd:!0,gridRowStart:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{},style:function(a,b,c,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g=P(b),h=Jb.test(b),k=a.style;h||(b=Sa(g));var l=d.cssHooks[b]||d.cssHooks[g];
if(void 0!==c){var m=typeof c;"string"===m&&(f=X.exec(c))&&f[1]&&(c=ib(a,b,f),m="number");null!=c&&c===c&&("number"!==m||h||(c+=f&&f[3]||(d.cssNumber[g]?"":"px")),x.clearCloneStyle||""!==c||0!==b.indexOf("background")||(k[b]="inherit"),l&&"set"in l&&void 0===(c=l.set(a,c,e))||(h?k.setProperty(b,c):k[b]=c))}else return l&&"get"in l&&void 0!==(f=l.get(a,!1,e))?f:k[b]}},css:function(a,b,c,e){var f;var g=P(b);Jb.test(b)||(b=Sa(g));(g=d.cssHooks[b]||d.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,c));void 0===
f&&(f=za(a,b,e));"normal"===f&&b in Kb&&(f=Kb[b]);return""===c||c?(a=parseFloat(f),!0===c||isFinite(a)?a||0:f):f}});d.each(["height","width"],function(a,b){d.cssHooks[b]={get:function(a,e,f){if(e)return!sc.test(d.css(a,"display"))||a.getClientRects().length&&a.getBoundingClientRect().width?wb(a,b,f):Ib(a,tc,function(){return wb(a,b,f)})},set:function(a,e,f){var c,h=Ja(a),k=!x.scrollboxSize()&&"absolute"===h.position,l=(k||f)&&"border-box"===d.css(a,"boxSizing",!1,h);f=f?Ta(a,b,f,l,h):0;l&&k&&(f-=
...
return this}};I.prototype.init.prototype=I.prototype;I.propHooks={_default:{get:function(a){return 1!==a.elem.nodeType||null!=a.elem[a.prop]&&null==a.elem.style[a.prop]?a.elem[a.prop]:(a=d.css(a.elem,a.prop,""))&&"auto"!==a?a:0},set:function(a){if(d.fx.step[a.prop])d.fx.step[a.prop](a);else 1!==a.elem.nodeType||!d.cssHooks[a.prop]&&null==a.elem.style[Sa(a.prop)]?a.elem[a.prop]=a.now:d.style(a.elem,a.prop,a.now+a.unit)}}};I.propHooks.scrollTop=I.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};d.fx=I.prototype.init;d.fx.step={};var Y,Ka,uc=/^(?:toggle|show|hide)$/,vc=/queueHooks$/;d.Animation=d.extend(C,{tweeners:{"*":[function(a,b){var c=this.createTween(a,b);ib(c.elem,a,X.exec(b),c);return c}]},tweener:function(a,b){q(a)?(b=a,a=["*"]):a=a.match(R);for(var c,d=0,f=a.length;d<f;d++)c=a[d],C.tweeners[c]=C.tweeners[c]||[],C.tweeners[c].unshift(b)},
prefilters:[function(a,b,c){var e;var f="width"in b||"height"in b;var g=this,h={},k=a.style,l=a.nodeType&&Ea(a),m=t.get(a,"fxshow");if(!c.queue){var n=d._queueHooks(a,"fx");if(null==n.unqueued){n.unqueued=0;var p=n.empty.fire;n.empty.fire=function(){n.unqueued||p()}}n.unqueued++;g.always(function(){g.always(function(){n.unqueued--;d.queue(a,"fx").length||n.empty.fire()})})}for(e in b){var r=b[e];if(uc.test(r)){delete b[e];var u=u||"toggle"===r;if(r===(l?"hide":"show"))if("show"===r&&m&&void 0!==m[e])l=
...
(k.overflow="hidden",g.always(function(){k.overflow=c.overflow[0];k.overflowX=c.overflow[1];k.overflowY=c.overflow[2]}));b=!1;for(e in h)b||(m?"hidden"in m&&(l=m.hidden):m=t.access(a,"fxshow",{display:q}),u&&(m.hidden=!l),l&&la([a],!0),g.done(function(){l||la([a]);t.remove(a,"fxshow");for(e in h)d.style(a,e,h[e])})),b=yb(l?m[e]:0,e,g),e in m||(m[e]=b.start,l&&(b.end=b.start,b.start=0))}}],prefilter:function(a,b){b?C.prefilters.unshift(a):C.prefilters.push(a)}});d.speed=function(a,b,c){var e=a&&"object"===
...
delete b.finish})}});d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,g){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(La(b,!0),a,d,g)}});d.each({slideDown:La("show"),slideUp:La("hide"),slideToggle:La("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){d.fn[a]=function(a,d,f){return this.animate(b,a,d,f)}});d.timers=[];d.fx.tick=function(){var a=0,b=d.timers;for(Y=Date.now();a<b.length;a++){var c=
b[a];c()||b[a]!==c||b.splice(a--,1)}b.length||d.fx.stop();Y=void 0};d.fx.timer=function(a){d.timers.push(a);d.fx.start()};d.fx.interval=13;d.fx.start=function(){Ka||(Ka=!0,Ua())};d.fx.stop=function(){Ka=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fn.delay=function(a,b){a=d.fx?d.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,d){var c=u.setTimeout(b,a);d.stop=function(){u.clearTimeout(c)}})};(function(){var a=v.createElement("input"),b=v.createElement("select").appendChild(v.createElement("option"));
a.type="checkbox";x.checkOn=""!==a.value;x.optSelected=b.selected;a=v.createElement("input");a.value="t";a.type="radio";x.radioValue="t"===a.value})();var ua=d.expr.attrHandle;d.fn.extend({attr:function(a,b){return O(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})}});d.extend({attr:function(a,b,c){var e,f,g=a.nodeType;if(3!==g&&8!==g&&2!==g){if("undefined"===typeof a.getAttribute)return d.prop(a,b,c);1===g&&d.isXMLDoc(a)||(f=d.attrHooks[b.toLowerCase()]||
...
d.prop(this,"elements");return a?d.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!d(this).is(":disabled")&&Bc.test(this.nodeName)&&!Ac.test(a)&&(this.checked||!ta.test(a))}).map(function(a,b){a=d(this).val();return null==a?null:Array.isArray(a)?d.map(a,function(a){return{name:b.name,value:a.replace(Ob,"\r\n")}}):{name:b.name,value:a.replace(Ob,"\r\n")}}).get()}});var Cc=/%20/g,Dc=/#.*$/,Ec=/([?&])_=[^&]*/,Fc=/^(.*?):[ \t]*([^\r\n]*)$/mg,Gc=/^(?:GET|HEAD)$/,Hc=/^\/\//,Pb=
...
m.dataTypes)&&0>d.inArray("json",m.dataTypes)&&(m.converters["text script"]=function(){});l=ic(m,l,z,g);if(g)if(m.ifModified&&((c=z.getResponseHeader("Last-Modified"))&&(d.lastModified[B]=c),(c=z.getResponseHeader("etag"))&&(d.etag[B]=c)),204===a||"HEAD"===m.type)v="nocontent";else if(304===a)v="notmodified";else{v=l.state;var x=l.data;var A=l.error;g=!A}else if(A=v,a||!v)v="error",0>a&&(a=0);z.status=a;z.statusText=(b||v)+"";g?r.resolveWith(n,[x,v,z]):r.rejectWith(n,[z,v,A]);z.statusCode(t);t=void 0;
k&&p.trigger(g?"ajaxSuccess":"ajaxError",[z,m,g?x:A]);q.fireWith(n,[z,v]);k&&(p.trigger("ajaxComplete",[z,m]),--d.active||d.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,k,l,m=d.ajaxSetup({},b),n=m.context||m,p=m.context&&(n.nodeType||n.jquery)?d(n):d.event,r=d.Deferred(),q=d.Callbacks("once memory"),t=m.statusCode||{},x={},E={},F="canceled",z={readyState:0,getResponseHeader:function(a){var b;if(C){if(!g)for(g={};b=Fc.exec(f);)g[b[1].toLowerCase()+" "]=(g[b[1].toLowerCase()+
" "]||[]).concat(b[2]);b=g[a.toLowerCase()+" "]}return null==b?null:b.join(", ")},getAllResponseHeaders:function(){return C?f:null},setRequestHeader:function(a,b){null==C&&(a=E[a.toLowerCase()]=E[a.toLowerCase()]||a,x[a]=b);return this},overrideMimeType:function(a){null==C&&(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(C)z.always(a[z.status]);else for(b in a)t[b]=[t[b],a[b]];return this},abort:function(a){a=a||F;e&&e.abort(a);c(0,a);return this}};r.promise(z);m.url=((a||m.url||
va.href)+"").replace(Hc,va.protocol+"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=(m.dataType||"*").toLowerCase().match(R)||[""];if(null==m.crossDomain){a=v.createElement("a");try{a.href=m.url,a.href=a.href,m.crossDomain=bb.protocol+"//"+bb.host!==a.protocol+"//"+a.host}catch(qa){m.crossDomain=!0}}m.data&&m.processData&&"string"!==typeof m.data&&(m.data=d.param(m.data,m.traditional));Ab(Pb,m,b,z);if(C)return z;(k=d.event&&m.global)&&0===d.active++&&d.event.trigger("ajaxStart");m.type=
m.type.toUpperCase();m.hasContent=!Gc.test(m.type);var B=m.url.replace(Dc,"");m.hasContent?m.data&&m.processData&&0===(m.contentType||"").indexOf("application/x-www-form-urlencoded")&&(m.data=m.data.replace(Cc,"+")):(a=m.url.slice(B.length),m.data&&(m.processData||"string"===typeof m.data)&&(B+=(ab.test(B)?"&":"?")+m.data,delete m.data),!1===m.cache&&(B=B.replace(Ec,"$1"),a=(ab.test(B)?"&":"?")+"_="+Nb++ +a),m.url=B+a);m.ifModified&&(d.lastModified[B]&&z.setRequestHeader("If-Modified-Since",d.lastModified[B]),
d.etag[B]&&z.setRequestHeader("If-None-Match",d.etag[B]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&z.setRequestHeader("Content-Type",m.contentType);z.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Qb+"; q=0.01":""):m.accepts["*"]);for(l in m.headers)z.setRequestHeader(l,m.headers[l]);if(m.beforeSend&&(!1===m.beforeSend.call(n,z,m)||C))return z.abort();F="abort";q.add(m.complete);z.done(m.success);z.fail(m.error);
if(e=Ab(Xa,m,b,z)){z.readyState=1;k&&p.trigger("ajaxSend",[z,m]);if(C)return z;m.async&&0<m.timeout&&(h=u.setTimeout(function(){z.abort("timeout")},m.timeout));try{var C=!1;e.send(x,c)}catch(qa){if(C)throw qa;c(-1,qa)}}else c(-1,"No Transport");return z},getJSON:function(a,b,c){return d.get(a,b,c,"json")},getScript:function(a,b){return d.get(a,void 0,b,"script")}});d.each(["get","post"],function(a,b){d[b]=function(a,e,f,g){q(e)&&(g=g||f,f=e,e=void 0);return d.ajax(d.extend({url:a,type:b,dataType:g,
...
d.expr.pseudos.hidden=function(a){return!d.expr.pseudos.visible(a)};d.expr.pseudos.visible=function(a){return!!(a.offsetWidth||a.offsetHeight||a.getClientRects().length)};d.ajaxSettings.xhr=function(){try{return new u.XMLHttpRequest}catch(a){}};var Ic={0:200,1223:204},Ca=d.ajaxSettings.xhr();x.cors=!!Ca&&"withCredentials"in Ca;x.ajax=Ca=!!Ca;d.ajaxTransport(function(a){var b,c;if(x.cors||Ca&&!a.crossDomain)return{send:function(d,f){var e,h=a.xhr();h.open(a.type,a.url,a.async,a.username,a.password);
if(a.xhrFields)for(e in a.xhrFields)h[e]=a.xhrFields[e];a.mimeType&&h.overrideMimeType&&h.overrideMimeType(a.mimeType);a.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");for(e in d)h.setRequestHeader(e,d[e]);b=function(a){return function(){b&&(b=c=h.onload=h.onerror=h.onabort=h.ontimeout=h.onreadystatechange=null,"abort"===a?h.abort():"error"===a?"number"!==typeof h.status?f(0,"error"):f(h.status,h.statusText):f(Ic[h.status]||h.status,h.statusText,"text"!==(h.responseType||
...
contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(a){d.globalEval(a);return a}}});d.ajaxPrefilter("script",function(a){void 0===a.cache&&(a.cache=!1);a.crossDomain&&(a.type="GET")});d.ajaxTransport("script",function(a){if(a.crossDomain||a.scriptAttrs){var b,c;return{send:function(e,f){b=d("<script>").attr(a.scriptAttrs||{}).prop({charset:a.scriptCharset,src:a.url}).on("load error",c=function(a){b.remove();c=null;a&&f("error"===a.type?404:200,a.type)});v.head.appendChild(b[0])},
...
"$1"+g):!1!==a.jsonp&&(a.url+=(ab.test(a.url)?"&":"?")+a.jsonp+"="+g);a.converters["script json"]=function(){e||d.error(g+" was not called");return e[0]};a.dataTypes[0]="json";var h=u[g];u[g]=function(){e=arguments};c.always(function(){void 0===h?d(u).removeProp(g):u[g]=h;a[g]&&(a.jsonpCallback=b.jsonpCallback,Rb.push(g));e&&q(h)&&h(e[0]);e=h=void 0});return"script"}});x.createHTMLDocument=function(){var a=v.implementation.createHTMLDocument("").body;a.innerHTML="<form></form><form></form>";return 2===
a.childNodes.length}();d.parseHTML=function(a,b,c){if("string"!==typeof a)return[];"boolean"===typeof b&&(c=b,b=!1);if(!b)if(x.createHTMLDocument){b=v.implementation.createHTMLDocument("");var e=b.createElement("base");e.href=v.location.href;b.head.appendChild(e)}else b=v;e=Fb.exec(a);c=!c&&[];if(e)return[b.createElement(e[1])];e=kb([a],b,c);c&&c.length&&d(c).remove();return d.merge([],e.childNodes)};d.fn.load=function(a,b,c){var e,f,g=this,h=a.indexOf(" ");if(-1<h){var k=ca(a.slice(h));a=a.slice(0,
...
a,d):this.trigger(b)}});var Jc=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;d.proxy=function(a,b){if("string"===typeof b){var c=a[b];b=a;a=c}if(q(a)){var e=S.call(arguments,2);c=function(){return a.apply(b||this,e.concat(S.call(arguments)))};c.guid=a.guid=a.guid||d.guid++;return c}};d.holdReady=function(a){a?d.readyWait++:d.ready(!0)};d.isArray=Array.isArray;d.parseJSON=JSON.parse;d.nodeName=K;d.isFunction=q;d.isWindow=ja;d.camelCase=P;d.type=Z;d.now=Date.now;d.isNumeric=function(a){var b=d.type(a);return("number"===
b||"string"===b)&&!isNaN(a-parseFloat(a))};d.trim=function(a){return null==a?"":(a+"").replace(Jc,"")};"function"===typeof define&&define.amd&&define("jquery",[],function(){return d});var Kc=u.jQuery,Lc=u.$;d.noConflict=function(a){u.$===d&&(u.$=Lc);a&&u.jQuery===d&&(u.jQuery=Kc);return d};"undefined"===typeof wa&&(u.jQuery=u.$=d);return d});