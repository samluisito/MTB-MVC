 ...
 * Nota: Debería desactivarse o eliminarse en un entorno de producción.
 *
...
$isLocal = preg_match('/^(127\.|192\.|localhost$)/', count($arrHost) == 1 ? $arrHost[0] : $arrHost[1]);
if ($isLocal) {
...
// --- Carga de Archivos del Núcleo de la Aplicación ---
 ...
 * y, a su vez, la conexión a la base de datos a través de la herencia de `Mysql` a `Conexion`.
