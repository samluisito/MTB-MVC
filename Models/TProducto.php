...
trait TProducto
{
    ...
    public function getProductosT($limitProd)
    {
        $this->con = new Mysql();
    ...
    public function getProductosPaginadoT($desde, $limitProd)
    {
        $this->con = new Mysql();
    ...
    public function countProductosPorCategoria(string $ruta)
    {
        $this->con = new Mysql();
        $this->strRuta = $ruta;
    ...
    public function getProductosCategoriaPaginadoT(string $ruta, $desde, $limitProd)
    {
        $this->con = new Mysql();
        $this->strRuta = $ruta;
        $this->Cat = $this->con->select("SELECT idcategoria FROM producto_categoria WHERE ruta = '{$this->strRuta}'")['idcategoria'];
    ...
    public function countProductosPorBusquedaT(string $search)
    {
        $this->con = new Mysql();
    ...
    public function getProductosBusquedaPaginadoT(string $search, $desde, $limitProd)
    {
        $this->con = new Mysql();
    ...
    public function getProductoId(string $ruta)
    {
        $this->con = new Mysql();
        $this->strRuta = $ruta;
    ...
    public function getProductosRamdom(int $cantidad, string $orden, int $idCategoria = null, int $idProducto = null)
    {
        ...
        switch ($orden) {
            case 'r':
                ...
                break;
            case 'a':
                $this->strOrden = 'idproducto ASC ';
                break;
            case 'd':
                $this->strOrden = 'idproducto DESC ';
                break;
            default:
                $this->strOrden = "";
                break;
    ...
    public function getProductoIdInfoCarT(int $idProducto)
    {
        $this->con = new Mysql();
    ...
    public function addFav($idprod, $idpers)
    {
        ...
        return !$request ?
            ($this->con->insert(
                ...
                array($this->intIdProducto, $this->intPersonaid)
            ) == 0 ? 'ok' : '') : 'existe';
    }
