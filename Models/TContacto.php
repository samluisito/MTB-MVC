...
trait TContacto
{
    ...
    public function newContacto(
        ...
        $arrData = [
            $this->origen, $this->nombre, $this->apellido, $this->telefono,
            $this->email, $this->mensaje, $this->ip_contacto, $this->geoplugin,
            $this->localidad, $this->ciudad, $this->pais, $this->dispositivo,
            $this->os, $this->navegador
        ];

        return $this->con->insert($sql, $arrData);
    }
}